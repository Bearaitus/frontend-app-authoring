...
const messages = defineMessages({
  ...
  videoDurationLongDescription: {
    ...
    defaultMessage: 'Пользователи лучше всего взаимодействуют с короткими видео, за которыми следуют возможности для практики. Убедитесь, что 80% или более видео курса имеют продолжительность менее 10 минут.',
  ...
  proctoringEmailLongDescription: {
    ...
    defaultMessage: 'Курсы, использующие Proctortrack, требуют электронной почты для эскалации. Убедитесь, что пользователи и поддержка могут связаться с вашей командой курса по вопросам, связанным с прокторингом (например, апелляции, сброс экзамена и т. д.).',
