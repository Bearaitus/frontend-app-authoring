...
const messages = defineMessages({
  ...
  deleteDialogBody: {
    ...
    defaultMessage: 'Warning! You are about to delete a taxonomy containing {tagsCount} tags. Assigned organizations will no longer have access to the taxonomy, and any tags applied to course content will be removed.',
  },
