    ...
    >
      <Collapsible.Visible whenClosed className="p-0 pb-3">
        ...
        <div className="d-flex flex-row align-self-start">
          ...
          <IconButton alt={messages.expandAltText.defaultMessage} src={ExpandMore} iconAs={Icon} variant="dark" />
        </div>
      </Collapsible.Visible>
      <Collapsible.Visible whenOpen>
        <div className="d-flex flex-grow-1 w-75 x-small">{title}</div>
        <div className="align-self-start">
          <IconButton alt={messages.collapseAltText.defaultMessage} src={ExpandLess} iconAs={Icon} variant="dark" />
        </div>
      </Collapsible.Visible>
    </Collapsible.Trigger>
